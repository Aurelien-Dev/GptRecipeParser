...
namespace GptRecipeParser;


public class DescriptionGenerator
{
    public static async Task<(string, decimal)> GenerateDescription(string apiKey)
    {
    ...
    private static decimal CalculateCost(ChatCompletion result)
    {
        ////gpt-4o-mini
    ...
    private static async Task<string> ReadEmbeddedResourceAsync(string resourceName, Func<string, string>? textFormaterAction = null)
    {
